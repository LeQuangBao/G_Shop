        ...
        public string TuoiCaThe(int MaCaThe) {
            ...
            if(ngaytuoi.Years == 0) {
                if(ngaytuoi.Months == 0) {
                    ...
                    tuoi = ngaytuoi.Months.ToString() + " tháng " + Math.Abs((ngaytuoi.Days - ngaytuoi.Months * 30)).ToString() + " ngày";
                }
            } else {
                tuoi = ngaytuoi.Years.ToString() + " tuổi " + (ngaytuoi.Months - ngaytuoi.Years * 12).ToString() + " tháng";
            }
            return tuoi;
        }
